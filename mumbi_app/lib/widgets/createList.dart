...
import '../app.dart';
import 'customConfirmDialog.dart';
...
Widget createListTileDiaryPost(String _imageURL, String _name) {
  return Card(
    elevation: 0,
    margin: EdgeInsets.zero,
    child: ListTile(
                ...
                if (role == PREGNANCY_ROLE)
                  Padding(
                    ...
                    child: LinearPercentIndicator(
                      ...
                      percent: getOpposite(
                          calculatePercent(PREGNANCY_DAY, day > 0 ? day : 0)),
...
Widget createListTileSelectedAccount(BuildContext context, String _imageURL,
  ...
  return Padding(
    ...
    child: Card(
      ...
      shape: RoundedRectangleBorder(
        side: BorderSide(
          color: CurrentMember.id == id
              ? PINK_COLOR
              : LIGHT_DARK_GREY_COLOR.withOpacity(0.2),
        ),
      ...
      child: ListTile(
        ...
        subtitle: Row(
          children: [
            Text(role == MOM_ROLE && pregnancyId != "" && pregnancyId != null
                ? "Mẹ bầu"
                : role),
...
Widget createListTileNavigatorNoTrailing(
  ...
  return Card(
    ...
    child: ListTile(
      ...
      onTap: () async {
        showConfirmDialog(
            context, "Đăng xuất", "Bạn có muốn đăng xuất khỏi tài khoản này?",
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        "Ngày ${DateTimeConvert.getDay(diaryModel.createTime)} "
                      ...
                      Row(
                        children: [
                          Text(
                            "vào lúc ${DateTimeConvert.getTime(diaryModel.createTime)}",
                            style:
                                TextStyle(fontSize: 15.0, color: BLACK_COLOR),
                          ),
                          if (diaryModel.imageURL != null &&
                              diaryModel.imageURL != "" &&
                              CountImage(diaryModel.imageURL) >= 1)
                            Row(
                              children: [
                                Padding(
                                  padding:
                                ...
                                Text(
                                  CountImage(diaryModel.imageURL).toString(),
