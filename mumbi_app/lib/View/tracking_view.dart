...
class _TrackingState extends State<Tracking> {
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Align(
                            ...
                            child: Text('Các hoạt động cho bé:', style: BOLD_20,)),
                        SizedBox(height: 8,),
                        ListenToMusic(),
                        TellTheStory(),
                        ReadPoetry(),
        ...
        child: ListTile(
          title: Padding(
            ...
            child: Row(
              ...
              children: [
                IconButton(
                  icon: SvgPicture.asset(currentImage), onPressed: null,
                ),
  ...
  Widget PLayAndPause(){
    return IconButton(
        icon: Icon(btnIcon,color: BLACK_COLOR,),
        iconSize: 33,
        onPressed: (){
          if (isPlaying){
            audioPlayer.pause();
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              Text("Tháng ${DateTimeConvert.getCurrentMonth()}",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 18),),
              SizedBox(width: 4,),
              Icon(Icons.calendar_today_outlined, color: BLACK_COLOR,),
            ],
          )
        ],
      ),
      ...
      child: Column(
        children: <Widget>[
          Container(
            ...
            child: SvgPicture.asset(CurrentMember.pregnancyFlag == true ? img_beco : getGenderImage(childModel.gender)),
          ),
          Container(
              margin: EdgeInsets.only(top:4),
              child: Text(CurrentMember.pregnancyFlag == true ? "Thai kì đã được" : "Bé đã được" , style: SEMIBOLDWHITE_13,)
          ),
          Container(
              margin: EdgeInsets.only(top:4),
              child: Text(
                CurrentMember.pregnancyFlag == true
                    ? DateTimeConvert.pregnancyWeekAndDay(childModel.estimatedBornDate)
  ...
  String getGenderImage(num gender){
    switch(gender){
      case 1: return img_betrai;break;
      case 2: return img_begai;break;
      default: return img_beco;break;
    }
  }
    ...
    return customActivity(
      ...
      widget: ScopedModel(
          ...
          child: ScopedModelDescendant(
            builder: (BuildContext context, Widget child, ActivityViewModel model) {
              return model.loadingActivityMusicListModel == true
                ...
                itemBuilder: (context,index){
                  ActivityModel activityModel = model.activityMusicListModel[index];
          ...
          child: ScopedModelDescendant(
            builder: (BuildContext context, Widget child, ActivityViewModel model) {
              return model.loadingActivityPoetryListModel == true
                ...
                itemBuilder: (context,index){
                  ActivityModel activityModel = model.activityPoetryListModel[index];
                  return customListTilePlaylist(
                    activityModel.activityName,
                    ic_poet,
                    onClick: (){
          ...
          child: ScopedModelDescendant(
            builder: (BuildContext context, Widget child, ActivityViewModel model) {
              return model.loadingActivityStoryListModel == true
                ...
                itemBuilder: (context,index){
                  ActivityModel activityModel = model.activityStoryListModel[index];
                  return customListTilePlaylist(
                    activityModel.activityName,
                    ic_kechuyen,
                    onClick: (){
  ...
  Widget Empty(String title){
    return Padding(
      ...
      child: Center(child: Text(title,style: TextStyle(color: GREY_COLOR),)),
    );
  }
}
