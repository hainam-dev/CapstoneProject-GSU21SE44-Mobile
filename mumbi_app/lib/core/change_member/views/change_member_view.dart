...
class _ChangeAccountState extends State<ChangeAccount> {
          ...
          Expanded(
            child: ScopedModel(
                ...
                child: ScopedModelDescendant(
                  builder: (context, child, ChildViewModel model) {
  ...
  Widget Mom() {
    return ScopedModel(
        model: _momViewModel,
        child: ScopedModelDescendant(
          builder: (context, child, MomViewModel model) {
  ...
  Widget Dad() {
    return ScopedModel(
        model: _dadViewModel,
        child: ScopedModelDescendant(
          builder: (context, child, DadViewModel model) {
            return model.dadModel == null
                ? Container()
                : createListTileUnselectedAccount(context,
                    model.dadModel.imageURL, model.dadModel.fullName, DAD_ROLE);
          },
        ));
  }
}
