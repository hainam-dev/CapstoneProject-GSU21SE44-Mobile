...
class ReactionRepository {
  static Future<dynamic> apiGetPostReaction(num postId) async {
    var response = await http.get(
      Uri.parse("${GET_REACTION}").replace(queryParameters: {
  ...
  static Future<dynamic> apiCheckCommentReaction(
      String userId, num commentId) async {
    var response = await http.get(
      Uri.parse("${GET_REACTION}").replace(queryParameters: {
        "UserId": userId,
  ...
  static Future<dynamic> apiGetCommentReaction(num commentId) async {
    var response = await http.get(
      Uri.parse("${GET_REACTION}").replace(queryParameters: <String, String>{
        "CommentId": commentId.toString(),
      }),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
  ...
  static Future<dynamic> apiAddPostReaction(ReactionModel reactionModel) async {
    var response = await http.post(Uri.parse("${ADD_POST_REACTION}"),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8'
        },
  ...
  static Future<dynamic> apiAddCommentReaction(
      ReactionModel reactionModel) async {
    var response = await http.post(Uri.parse("${ADD_COMMENT_REACTION}"),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8'
        },
        body: jsonEncode(reactionModel.toJson()));
