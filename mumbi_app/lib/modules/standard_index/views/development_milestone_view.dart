...
class DevelopmentMilestone extends StatefulWidget {
  const DevelopmentMilestone({Key key}) : super(key: key);

  @override
  _DevelopmentMilestoneState createState() => _DevelopmentMilestoneState();
}

class _DevelopmentMilestoneState extends State<DevelopmentMilestone> {
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: createFlatButton(
                  context, 'Cập nhật sự vận động của bé', ActionDetails())),
        ],
      ),
    );
  }
