...
import 'package:mumbi_app/modules/health_history/repositories/child_history_repository.dart';
...
class ChildHistoryViewModel extends Model {
  ...
  Future<bool> updateChildHistory(
      ChildHistoryModel childHistoryModel, String date) async {
    try {
      String result = await ChildHistoryRepository.apiUpdateChildHistory(
