...
import 'injection_update_token_view.dart';
  ...
  void onNextBtn() {
    if (formKey.currentState.validate()) {
      ...
      showCustomProgressDialog(
          ...
          "Vui lòng đợi",
          widget.isRecover
              ? InjectionSchedulesRepository.getOTPRecoveryPass(
                  phoneNoController.text)
              : InjectionSchedulesRepository.checkPhoneNo(
                  phoneNoController.text), (data) {
