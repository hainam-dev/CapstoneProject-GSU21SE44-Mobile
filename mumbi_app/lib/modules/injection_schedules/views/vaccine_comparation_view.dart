...
class VaccineComparation extends StatefulWidget {
  const VaccineComparation({Key key}) : super(key: key);

  @override
  _VaccineComparationState createState() => _VaccineComparationState();
}

class _VaccineComparationState extends State<VaccineComparation> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: VaccineComparationTable(),
    );
  }
}

class VaccineComparationTable extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
