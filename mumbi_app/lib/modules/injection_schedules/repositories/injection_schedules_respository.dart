...
import 'package:mumbi_app/modules/injection_schedules/models/history_vaccination.dart';
import 'package:shared_preferences/shared_preferences.dart';

class InjectionSchedulesRepository {
  ...
  static Future<dynamic> personListSynchronization() async {
    ...
    if (value != null) {
      ...
      if (json["code"] == 1) {
        List data = json["data"];
        if (data != null) {
          InjectionSchedulesRepository.setDoi_tuong_ids(data
  ...
  static Future<dynamic> historyListSynchronization() async {
    ...
    for (final e in doi_tuong_ids) {
      var res = await InjectionSchedulesRepository.getHistoryList(int.parse(e));
      if (res != null) {
        var jsonObject = jsonDecode(res);
        Iterable listHistory = jsonObject['data'];
        if (listHistory != null) {
          var res1 = await InjectionSchedulesRepository.sendHistoryList(
