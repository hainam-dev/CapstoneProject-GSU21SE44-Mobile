...
class _NewsDetailState extends State<NewsDetail> {
  ...
  void initState() {
    ...
    relatedNewsViewModel.getRelatedNews(
        widget.model.typeId, widget.model.newsId);
                      ...
                      children: [
                        ...
                        for (var newsModel in model.newsListModel)
                          NormalCardItem(
                              newsModel.imageURL,
                              newsModel.title,
                              newsModel.createTime,
                              newsModel.estimatedFinishTime, onTap: () {
                ...
                : IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if (model.savedNewsModel.id == 0) {
                        result = await SavedNewsViewModel()
                            .saveNews(widget.model.newsId);
                      } else {
                        result = await SavedNewsViewModel()
                            .unsavedNews(model.savedNewsModel.id);
