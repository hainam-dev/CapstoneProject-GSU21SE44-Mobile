...
import 'package:mumbi_app/modules/activity/repositories/activity_repository.dart';
    ...
    if (id == 1) {
      ...
      try {
        ...
        if (activityMusicList != null) {
          activityMusicListModel =
              activityMusicList.map((e) => ActivityModel.fromJson(e)).toList();
        }
        notifyListeners();
      ...
      try {
        ...
        if (activityPoetryList != null) {
          activityPoetryListModel =
              activityPoetryList.map((e) => ActivityModel.fromJson(e)).toList();
        }
        notifyListeners();
      ...
      try {
        ...
        if (activityStoryList != null) {
          activityStoryListModel =
              activityStoryList.map((e) => ActivityModel.fromJson(e)).toList();
        }
        notifyListeners();
