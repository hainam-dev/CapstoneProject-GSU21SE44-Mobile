                    ...
                    child: ScopedModelDescendant(
                      builder: (BuildContext context, Widget child,
                        ...
                        return model.dadModel == null
                            ? createAddFamilyCard(context, "Thêm cha",
                                onClick: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ParentInfo(
                                          DAD_APP_BAR_TITLE, "", CREATE_STATE)),
                                );
              ...
              child: ScopedModelDescendant(builder:
                ...
                return model.childListModel == null
                    ? Align(
                        ...
                        child: createAddFamilyCard(context, "Thêm bé",
                            onClick: () async {
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ChildrenInfo(
                                    "", CREATE_STATE, CHILD_ENTRY)),
                          );
                        ...
                        child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, index) {
                              if (index == model.childListModel.length) {
                                return createAddFamilyCard(context, "Thêm bé",
                                    onClick: () async {
                                  await Navigator.push(
                                    context,
                                    MaterialPageRoute(
